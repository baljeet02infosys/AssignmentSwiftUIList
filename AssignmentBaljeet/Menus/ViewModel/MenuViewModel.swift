...
class MenuModelView: ObservableObject {
    ...
    func getMenus()
    {
//        HTTPRequest.init(fullURLStr: "https://dl.dropboxusercontent.com/s/2iodh4vg0eortkl/facts.json", encoding: .url).handler { result in
//            print(result.getServerResponseModal().data)
//        }
